      ...
      <section className="py-6 md:py-15">
        <div className="mx-auto grid max-w-6xl gap-12 px-4 md:grid-cols-2 md:items-start">
          ...
          <div className="rounded-[20px] border border-slate-200 dark:border-white/10 bg-white dark:bg-zinc-900 p-10 shadow-[0_20px_50px_rgba(0,0,0,0.04)] md:sticky md:top-24">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white">Canales directos</h2>
            ...
            <div className="mt-10 rounded-[10px] border border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-zinc-950/50 p-8">
              <p className="text-lg font-bold text-slate-900 dark:text-white italic underline decoration-slate-200 dark:decoration-zinc-800 underline-offset-4">Horario de atención</p>
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-2">
              <div className="grid gap-3 md:grid-cols-1">
                <div className="space-y-1">
                  <label className="text-sm font-bold text-slate-700 dark:text-zinc-300 ml-1 uppercase tracking-wide">Nombre</label>
                  <input
                    required
                    name="name"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-bold text-slate-700 dark:text-zinc-300 ml-1 uppercase tracking-wide">Número</label>
                  <input
                    required
                    name="phone"
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-slate-700 dark:text-zinc-300 ml-1 uppercase tracking-wide">Mensaje o Dirección</label>
                <textarea
                  required
                  name="message"
              ...
              <div className="flex items-start gap-3 py-2">
                <input required type="checkbox" className="mt-1.5 h-4 w-4 rounded accent-slate-900 dark:accent-white" defaultChecked />
                <p className="text-sm text-slate-600 dark:text-zinc-400">
                  Acepto ser contactado y entiendo la{" "}
                  <a className="font-bold text-slate-900 dark:text-white underline underline-offset-4" href="/privacidad">
