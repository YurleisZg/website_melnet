export default function TermsPage() {
  return (
    <main className="bg-white dark:bg-zinc-950 transition-colors" id="terminos-y-condiciones">
      {/* Header con borde adaptativo */}
      ...
      <section className="py-12 md:py-6">
        <div className="mx-auto max-w-6xl px-4">
          <div className="prose prose-slate max-w-none text-black dark:text-zinc-300">
            <h2 className="font-semibold text-lg dark:text-white">1. Uso del sitio</h2>
            <p className="mb-4">
            ...
            <h2 className="font-semibold text-lg dark:text-white">2. Elegibilidad</h2>
            <p className="mb-4">
            ...
            <h2 className="font-semibold text-lg dark:text-white">3. Solicitudes y contratación</h2>
            <p className="mb-4">
            ...
            <h2 className="font-semibold text-lg dark:text-white">4. Pagos, cortes y reconexión</h2>
            <p className="mb-4">
              Los procesos de pago, suspensión y reconexión se rigen por las condiciones del plan contratado
              y la normativa aplicable.
            </p>

            <h2 className="font-semibold text-lg dark:text-white">5. Limitación de responsabilidad</h2>
            <p className="mb-4">
            ...
            <h2 className="font-semibold text-lg dark:text-white">6. Privacidad y datos personales</h2>
            <p className="mb-4">
            ...
            <h2 className="font-semibold text-lg dark:text-white">7. Soporte técnico</h2>
            <p className="mb-4">
            ...
            <h2 className="font-semibold text-lg dark:text-white">8. Garantías del servicio</h2>
            <p className="mb-4">
            ...
            <h2 className="font-semibold text-lg dark:text-white">9. Propiedad intelectual</h2>
            <p className="mb-4">
            ...
            <h2 className="font-semibold text-lg dark:text-white">10. Terminación del servicio</h2>
            <p className="mb-4">
            ...
            <h2 className="font-semibold text-lg dark:text-white">11. Resolución de conflictos</h2>
            <p className="mb-4">
            ...
            <h2 className="font-semibold text-lg dark:text-white">12. Cambios en los términos</h2>
            <p className="mb-4">
              Podemos actualizar estos términos cuando sea necesario. Los cambios se publicarán en 
              esta página y recomendamos revisarla periódicamente. El uso continuado del servicio 
